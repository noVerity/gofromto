...
var ConversionList = []Conversion{
	...
	{Teaspoon, Hint, func(amount float64) float64 { return amount / 128 }, true},
	{Hint, Teaspoon, func(amount float64) float64 { return amount * 128 }, true},
	{Teaspoon, Drop, func(amount float64) float64 { return amount / 64 }, true},
	{Drop, Teaspoon, func(amount float64) float64 { return amount * 64 }, true},
	{Teaspoon, Smidgen, func(amount float64) float64 { return amount / 32 }, true},
	{Smidgen, Teaspoon, func(amount float64) float64 { return amount * 32 }, true},
	{Teaspoon, Pinch, func(amount float64) float64 { return amount / 16 }, true},
	{Pinch, Teaspoon, func(amount float64) float64 { return amount * 16 }, true},
	{Teaspoon, Dash, func(amount float64) float64 { return amount / 8 }, true},
	{Dash, Teaspoon, func(amount float64) float64 { return amount * 8 }, true},
	// Weight
